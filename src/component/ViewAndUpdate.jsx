  ...
  const validate = () => {
    ...
    if (isFullEditEnabled) {
      ...
      const validateAddress = (address, key) => {
        const addrErr = {};
        if (!address.addressLine1) addrErr.addressLine1 = "Address Line 1 required";
        if (!address.city) addrErr.city = "City required";
        else if (!onlyTextRegex.test(address.city)) addrErr.city = "Only characters allowed";
        ...
        else if (!pincodeRegex.test(address.pincode)) addrErr.pincode = "Invalid pincode";
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className={styles.section}>
            <div className={styles.sectionHeader}>
              ...
              <button
                type="button"
                className={isFullEditEnabled ? styles.cancelBtn : styles.editBtn}
                onClick={() => {
